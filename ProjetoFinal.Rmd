...
## Regressão Logística (valores contínuos)
# colnames(data_amostragem) <- make.names(colnames(data_amostragem))
# 
# data_amostragem$`Avg Salary(K)Amostrado`[positions] <- NA
# data_amostragem <- mice(
#   data_amostragem, 
#   method = 'logreg', 
#   m = 1)
# 
# print(paste("R Quadrado Para Regressão Logística: ",
#             r_squared(obs = data_amostragem$`AvgSalary(K)`,
#                       pred = data_amostragem$`AvgSalary(K)Amostrado`)))
```
